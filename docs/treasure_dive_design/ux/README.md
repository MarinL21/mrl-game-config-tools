...
https://rawcdn.githack.com/MarinL21/mrl-game-config-tools/d70a67b/docs/treasure_dive_design/ux/intro3.preview.html
...
> githack 链接里那段 `d70a67b` 是 commit sha，**换稿后要换成新 sha** 才是新版本（sha 版永久缓存、不会串版）。
